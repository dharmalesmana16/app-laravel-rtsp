            ...
            <form x-data="{
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <x-text-input id="name" class="w-full" x-model="name" />
                    </div>
                    <div>
                        <x-input-label for="email" value="Email" />
                        <x-text-input type="email" id="email" class="w-full" x-model="email" />
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            <x-input-label for="password" value="Password Baru (kosongi jika tidak diubah)" />
                            <x-text-input type="password" id="password" class="w-full" x-model="password" />
                        </div>
                        <div>
                            <x-input-label for="password_confirmation" value="Konfirmasi Password" />
                            <x-text-input type="password" id="password_confirmation" class="w-full" x-model="password_confirmation" />
                        </div>
                    </div>
                    <div>
