                ...
                @foreach ($cameras as $camera)
                    <div x-data="{
                            ...
                            init() {
                                ...
                                this.player = new jsmpeg(new WebSocket(window.streamWsUrl({{ $camera->http_port }})), {
                                    canvas: this.$refs.thumb,
                                    autoplay: true,
                                    loop: true,
                                });
                            }
                        ...
                        <div class="p-4">
                            ...
                            <div class="mt-4">
                                <x-modal-view-streaming id_canvas="{{ $camera->id }}"
                                    modalport="{{ $camera->http_port }}"></x-modal-view-streaming>
                            </div>
                        </div>
                    </div>
                @endforeach
