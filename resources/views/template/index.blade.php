        ...
        <div class="container px-4 py-3 mx-auto">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                ...
                <ul
                    ...
                    <li>
                        <a href="/devices"
                            class="flex items-center p-2 text-white rounded-lg hover:bg-second-500 group">
                            <svg class="shrink-0 w-5 h-5 text-white transition duration-75 group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path
                    ...
                    <li>
                        <a href="/log" class="flex items-center p-2 text-white rounded-lg hover:bg-second-500 group">
                            <svg class="shrink-0 w-5 h-5 text-white transition duration-75 group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path
